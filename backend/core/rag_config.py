...
RAG_MAX_CHARS = max(800, int(os.environ.get("RAG_MAX_CHARS", "7000")))
RAG_TOP_K = int(os.environ.get("RAG_TOP_K", "28"))
RAG_VECTOR_FILL_EXTRA = max(0, int(os.environ.get("RAG_VECTOR_FILL_EXTRA", "24")))
...
RAG_MULTI_EMBED = _env_bool("RAG_MULTI_EMBED", "true")
RAG_MULTI_EMBED_KEYWORD_LINE = _env_bool("RAG_MULTI_EMBED_KEYWORD_LINE", "true")
RAG_VECTOR_CANDIDATE_POOL = max(40, min(500, int(os.environ.get("RAG_VECTOR_CANDIDATE_POOL", "100"))))
